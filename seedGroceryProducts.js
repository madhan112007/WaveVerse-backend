...
async function seedProducts() {
    try {
        await mongoose.connect('mongodb+srv://root:sarasmad@cluster0.px6svbn.mongodb.net/waveverse?retryWrites=true&w=majority&appName=Cluster0');
        ...
        console.log(`Added ${groceryProducts.length} grocery products`);
